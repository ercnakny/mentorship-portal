...
const SectionPage = ({ section, user, onNavigate }) => {
  ...
  return (
    <div className="p-8">
      ...
      {/* Progress Bar */}
      <motion.div 
        className="bg-dark-200 rounded-2xl p-6 mb-12 border border-dark-100"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      {/* Circle Navigation */}
      <motion.div 
        className="flex items-center justify-center gap-3 md:gap-6 overflow-x-auto pb-8"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
          ...
          return (
            ...
            >
              ...
              {index < section.steps.length - 1 && (
                <div className={`
                  absolute top-8 left-full w-8 md:w-12 h-1
              ...
              {/* Step Label */}
              <p className={`
                mt-4 text-xs md:text-sm font-medium text-center
